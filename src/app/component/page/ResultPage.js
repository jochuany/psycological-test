                ...
                <div className="w-full h-full flex flex-col justify-center items-center">
                    ...
                    <div className="w-full h-full px-4 py-6 rounded-xl mb-8 flex flex-col justify-between relative"
                        ...
                        <div className="font-normal text-xs">
                            {(resultType == 1) && (<p className="text-white leading-8">你是大家的避風港，<br />常個性溫暖、善解人意。<br />你喜歡平穩的生活節奏，<br />常也樂於照顧身邊的人，<br />常像一杯簡單純粹的麥香奶茶，<br />常不張揚卻令人安心。</p>)}
                            {(resultType == 2) && (<p className="text-white leading-8">你喜歡分析、講究細節，做事有條理，<br />常常是團隊中最冷靜的一個。<br />你的世界像抹茶一樣沈穩、有深度，<br />不怕慢，只求穩。</p>)}
                            {(resultType == 3) && (<p className="text-white leading-8">你重視情感與連結，常懷念過去，<br />對朋友與記憶有著深深的眷戀。<br />像可可奶茶一樣香甜，<br />與你相處總讓人覺得溫暖又幸福。</p>)}
                            {(resultType == 4) && (<p className="text-white leading-8">你天生有份吸引力，<br />思維快速、說話有邏輯，<br />總是讓人忍不住跟著你走。<br />你就像泰奶一樣外表吸睛、口味濃烈，<br />是無法忽視的存在。</p>)}
                            {(resultType == 5) && (<p className="text-white leading-8">你不喜歡走傳統路線，<br />追求與眾不同、充滿創意。<br />你總能在平凡中找到獨特風味，<br />像芝麻豆乳奶茶般特別又難忘，<br />是生活中的另類靈感源泉。</p>)}
                        </div>
