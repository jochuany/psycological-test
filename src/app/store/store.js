...
const useQuestionStore = create((set) => ({
    question: {
        1: {
            ...
            options: [
                { title: "乖乖待著⋯ 然後偷偷膨脹三倍大", value: 5 },
                { title: "等個屁！我已經開始發酵狂飆了", value: 5 },
        ...
        2: {
            ...
            options: [
                { title: "啊啊啊啊啊啊！（冒泡炸裂）", value: 5 },
                { title: "熱熱熱快翻面！我要烤出最酥脆的皮！", value: 5 },
        ...
        3: {
            ...
            options: [
                { title: "立刻乾癟五公分，氣到扁掉", value: 5 },
                { title: "更用力散發麵包香，讓他後悔！", value: 5 },
